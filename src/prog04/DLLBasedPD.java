...
public class DLLBasedPD implements PhoneDirectory {
  ...
  */
  public String lookupEntry (String name) {
		...
		for(DLLEntry entry = head; entry != null; entry = entry.getNext()){ // DEBUG ONLY
  ...
  */
  public String removeEntry (String name) {
    ...
    if(fo.entry.getNext() == null && fo.entry.getPrevious() == null){
    	tail = null;
    	head = null;
        return fo.entry.getNumber();

    }
    if(fo.entry.getPrevious() == null){
    	head = fo.entry.getNext();
    	head.setPrevious(null);
        return fo.entry.getNumber();

    }
    if(fo.entry.getNext() == null){
    	tail = fo.entry.getPrevious();
    	tail.setNext(null);
        return fo.entry.getNumber();
    ...
    //normal case
    fo.entry.getPrevious().setNext(fo.entry.getNext());;
    fo.entry.getNext().setPrevious(fo.entry.getPrevious());
